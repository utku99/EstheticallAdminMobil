...
interface props {
  ...
  icon?: 'location' | 'send' | 'question' | 'pluss';
}
...
const CustomButtons: React.FC<props> = ({
  ...
  const handleIcon = () => {
    ...
    else if (icon == 'pluss') return <PlussIcon />;
  };
    ...
    <>
      ...
      {type == 'outlined' && (
        <TouchableOpacity
          ...
          <Text
            className={`ffont-poppinsMedium text-customGray  ${handleFontSize()}  `}>
            {label}
          </Text>
        </TouchableOpacity>
      )}
      ...
      {type == 'brownsolid' && (
        <TouchableOpacity
          ...
          <Text
            className={`font-poppinsSemiBold text-white  ${handleFontSize()}  `}>
            {label}
          </Text>
        </TouchableOpacity>
      )}
      {type == 'brownoutlined' && (
        <TouchableOpacity
          ...
          <Text
            className={`font-poppinsSemiBold text-customBrown  ${handleFontSize()} `}>
            {label}
          </Text>
        </TouchableOpacity>
      )}
