    ...
    <View
      ...
      <View className="flex-row items-center justify-between">
        ...
        <View className=" w-[50%]">
          <Text
            numberOfLines={1}
            className="text-customGray font-poppins text-xs font-bold">
            {item?.userName}
          </Text>
          <Text
            numberOfLines={1}
            className="text-customGray font-poppins text-xs">
            {item?.userLocation}
          </Text>
          <Text
            numberOfLines={1}
      ...
      <Text className="text-xs font-bold font-poppins text-customGray">
        {item?.subject}
      </Text>

      <View>
        <Text
          className={`text-xs font-poppins text-customGray ${
            seeAll
              ? 'h-fit'
      ...
      {/* doctor */}
      <View className="space-y-2">
        <Text className="text-base font-poppins text-customGray">
      ...
      <ModalWrapper visible={visible} setVisible={setVisible}>
        <View className="max-h-[90%]">
          <Text className="font-semibold text-customGray text-lg font-poppins mb-3">
            Yorumu Düzenle
          </Text>
          ...
          <Controller
            ...
            name="title"
            rules={{
              required: {value: true, message: 'başlık metni gereklidir'},
            }}
          />
