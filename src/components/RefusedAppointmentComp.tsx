...
const RefusedAppointmentComp = ({item}: any) => {
          ...
          <View className="p-[10px] space-y-3">
            ...
            <View className="flex-1">
              ...
              <Text
                ...
                Necessitatibus porro, cupiditate nisi voluptatibus enim
                perspiciatis et blanditiis quibusdam reiciendis est.
              </Text>
            </View>
...
export default RefusedAppointmentComp;
