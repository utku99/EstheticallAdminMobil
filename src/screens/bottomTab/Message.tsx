        ...
        <View className="flex-1">
          ...
          <View className="space-y-1">
            ...
            <View className="flex-row gap-3  relative">
              ...
              <View className="rounded-xl border border-customLightGray bg-white h-[40] overflow-hidden flex-row items-center flex-1">
                <TextInput
                  className=" flex-1 pl-2 placeholder:font-poppinsRegular placeholder:text-sm"
